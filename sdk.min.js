...
function log(...t){window.origin.includes("localhost")&&console.log(...t)}let ENV={PRODUCTION:"production",STAGING:"staging",DEV:"dev"},IFRAME_SRC_MAP={[ENV.PRODUCTION]:"https://ask-airo-dot-aichat-408808.ey.r.appspot.com",[ENV.STAGING]:"https://ask-airo-dot-aichat-408808.ey.r.appspot.com",[ENV.DEV]:"https://ask-airo-dot-aichat-408808.ey.r.appspot.com"};function normalizeChatType(t){return"salesforce"===String(t).toLowerCase()?"salesforce":"empower"}function buildIframeSrc(t,e={}){var i=normalizeChatType(e.chatType||e.chat_type),e="string"==typeof e.query?e.query.trim():"",o=new URLSearchParams;return o.set("chat_type",i),e&&o.set("query",e),t+"/chat/ask-airo?"+o.toString()}class AskAiroChat{isIframePresent=!1;isReady=!1;isOpen=!1;MESSAGE_TYPES={IS_READY:"is_ready",IS_CHATBOX_OPEN:"is_chatbox_open",SET_STYLES:"set_styles",URL_CHANGED:"url_changed"};CLOSED_CHAT_WIDTH="60px";CLOSED_CHAT_HEIGHT="60px";OPEN_CHAT_WIDTH="400px";OPEN_CHAT_HEIGHT="600px";constructor(t={}){if(!this.isIframePresent){t?.env||ENV.PRODUCTION;let i=t?.baseUrl||"https://ask-airo-dot-aichat-408808.ey.r.appspot.com";var e=buildIframeSrc(i,t);this.baseUrl=i,this.options=t,this.iframeSrc=e,this.createButton(t),this.createIframeContainer(t),this.isIframePresent=!0;window.addEventListener("message",t=>{var e=i;t.origin.includes(e.replace(/^https?:\/\//,"").split("/")[0])&&(log("MESSAGE FROM IFRAME",t.data),t.data?.type===this.MESSAGE_TYPES.IS_READY?this.isReady=!0:t.data?.type===this.MESSAGE_TYPES.IS_CHATBOX_OPEN&&(t.data.data?this.open():this.close()))}),this.trackUrlChanges(),setTimeout(()=>{this.sendMessage({type:this.MESSAGE_TYPES.IS_READY})},100)}}createButton(t){let e=document.createElement("button");var i=t?.position||"bottom-right",o=t?.buttonSize||60,s=t?.buttonColor||"#2563eb",a=t?.zIndex||9999,r=t?.offset||20;e.innerHTML=`
    ...
    `,i.setAttribute("allow","microphone; camera"),i.setAttribute("title","Ask Airo Chat"),e.appendChild(i),e.style.cssText=`
      ...
      background: white;
      display: block;
    `,"bottom-right"===o?(e.style.bottom=s+r+10+"px",e.style.right=r+"px"):"bottom-left"===o?(e.style.bottom=s+r+10+"px",e.style.left=r+"px"):"top-right"===o?(e.style.top=s+r+10+"px",e.style.right=r+"px"):"top-left"===o&&(e.style.top=s+r+10+"px",e.style.left=r+"px"),`
    ...
    `);document.getElementById("aura-chat-mobile-styles")||((t=document.createElement("style")).id="aura-chat-mobile-styles",t.textContent=n,document.head.appendChild(t)),document.body.appendChild(e),this.container=e,this.iframe=i}sendMessage(t){this.iframe&&this.iframe.contentWindow&&this.iframe.contentWindow.postMessage(t,"*")}updateButtonIcon(t){this.button&&(this.button.innerHTML=t?`
      <svg viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg" style="width: 28px; height: 28px; fill: white;">
        <path d="M19 6.41L17.59 5 12 10.59 6.41 5 5 6.41 10.59 12 5 17.59 6.41 19 12 13.41 17.59 19 19 17.59 13.41 12z"/>
      </svg>
    `:`
    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="white" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="lucide lucide-sparkles w-3.5 h-3.5 sm:w-4 sm:h-4 md:w-5 md:h-5 text-white"><path d="M9.937 15.5A2 2 0 0 0 8.5 14.063l-6.135-1.582a.5.5 0 0 1 0-.962L8.5 9.936A2 2 0 0 0 9.937 8.5l1.582-6.135a.5.5 0 0 1 .963 0L14.063 8.5A2 2 0 0 0 15.5 9.937l6.135 1.581a.5.5 0 0 1 0 .964L15.5 14.063a2 2 0 0 0-1.437 1.437l-1.582 6.135a.5.5 0 0 1-.963 0z"></path><path d="M20 3v4"></path><path d="M22 5h-4"></path><path d="M4 17v2"></path><path d="M5 18H3"></path></svg>
    `,this.button.setAttribute("aria-label",t?"Close Ask Airo Chat":"Open Ask Airo Chat"))}open(){this.isOpen||(this.isOpen=!0,this.container.style.opacity="1",this.container.style.visibility="visible",this.container.style.transform="scale(1) translateY(0)",this.container.style.pointerEvents="all",this.button.style.transform="scale(0.9)",this.updateButtonIcon(!0),this.iframe&&this.iframe.focus())}close(){this.isOpen&&(this.isOpen=!1,this.container.style.opacity="0",this.container.style.visibility="hidden",this.container.style.transform="scale(0.8) translateY(20px)",this.container.style.pointerEvents="none",this.button.style.transform="scale(1)",this.updateButtonIcon(!1))}toggle(){this.isOpen?this.close():this.open()}trackUrlChanges(){let e=()=>{var t=window.location.href;this.sendMessage({type:this.MESSAGE_TYPES.URL_CHANGED,url:t})},i=history.pushState,o=history.replaceState;history.pushState=(...t)=>{i.apply(history,t),e()},history.replaceState=(...t)=>{o.apply(history,t),e()},window.addEventListener("popstate",e),e()}updateConfig(t){this.options={...this.options,...t},this.destroy(),this.isIframePresent=!1;t=new AskAiroChat(this.options);Object.assign(this,t)}destroy(){this.button&&this.button.parentNode&&this.button.parentNode.removeChild(this.button),this.container&&this.container.parentNode&&this.container.parentNode.removeChild(this.container),this.isIframePresent=!1,this.isReady=!1,this.isOpen=!1}}function initWidget(){if(window.AuraChatWidget&&window.AuraChatWidget instanceof AskAiroChat)return window.AuraChatWidget;var t,e,i,o,s,a,r,n=document.currentScript||document.querySelector("script[data-aura-config]")||document.querySelector('script[src*="sdk"]');let h={};return n&&(r=n.getAttribute("data-base-url"),t=n.getAttribute("data-env"),e=n.getAttribute("data-position"),i=n.getAttribute("data-button-color"),o=n.getAttribute("data-button-size"),s=n.getAttribute("data-z-index"),a=n.getAttribute("data-chat-type"),n=n.getAttribute("data-query"),r&&(h.baseUrl=r),t&&(h.env=t),e&&(h.position=e),i&&(h.buttonColor=i),o&&(h.buttonSize=parseInt(o,10)),s&&(h.zIndex=parseInt(s,10)),a&&(h.chatType=a),n)&&(h.query=n),window.AuraChatConfig&&(h={...h,...window.AuraChatConfig}),0!==Object.keys(h).length||h.baseUrl?(r=new AskAiroChat(h),window.AuraChatWidget=r):null}window.AskAiroChat=AskAiroChat,window.AuraChatWidget=AskAiroChat,"undefined"!=typeof module&&module.exports&&(module.exports=AskAiroChat),"loading"===document.readyState?document.addEventListener("DOMContentLoaded",initWidget):setTimeout(initWidget,0);
